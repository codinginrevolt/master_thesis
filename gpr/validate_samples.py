...
def get_paths():
    ...
    if tov_config['output']['out_type'] == 'npy':
        ...
        save_dir_tov = Path(f"{tov_config['output']['path']}/{tov_config['output']['filename']}")
        ...
        save_dir_tov = Path(f"{tov_config['output']['path']}/{tov_config['output']['filename']}/valids")
...
def main():
    ...
    eos_pathname, rescale_pathname, tov_pathname, save_dir_eos, save_dir_tov = get_paths()
