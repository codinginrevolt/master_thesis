...
def get_ceft(value:str):
    ...
    eos_l_ceft = eos.EosProperties(n_ceft, phi=None, epsi_0 = e_ini_ceft, p_0 = p_ini_ceft, mu_0=mu_ini_ceft, cs2=cs2_l_ceft)
    eos_u_ceft = eos.EosProperties(n_ceft, phi=None, epsi_0 = e_ini_ceft, p_0 = p_ini_ceft, mu_0=mu_ini_ceft, cs2=cs2_u_ceft)
...
def get_ceft_cs2_old():
    ...
    cs2_ceft_upper,
    """       
    n_ceft_lower, p_ceft_lower, e_ceft_lower, p_ceft_upper, e_ceft_upper = _load_ceft_old()
...
def get_crust_old(value:str):
    ...
    n_crust, p_crust_lower, e_crust_lower, p_crust_upper, e_crust_upper = _load_ceft_old()
